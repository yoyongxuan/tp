...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_TELEGRAM_HANDLE)
        ...
        Person person = new Person.PersonBuilder(name, phone, email, studentId, telegramHandle)
                .withTags(tagSet).build();
