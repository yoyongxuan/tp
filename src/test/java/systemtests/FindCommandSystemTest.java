...
import static seedu.address.testutil.TypicalPersons.BENSON_DEFAULT;
...
public class FindCommandSystemTest extends AddressBookSystemTest {
    ...
    public void find() {
        ...
        ModelHelper.setFilteredList(expectedModel, BENSON_DEFAULT, DANIEL);
        ...
        assertFalse(getModel().getAddressBook().getPersonList().contains(BENSON_DEFAULT));
        command = FindCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_MEIER;
